  ...
  <div>
   <div className="mobile">
      ...
      <div className="overlay">
              <h1 className="display-5">Crypto Trade Chaining</h1>
              ...
              <p className="lead">
                <Link className="btn btn-danger btn-lg" to="/tracking/currencies" role="button">VISIT OUR CRYPTO TRACKING APP</Link>
              </p>
        </div>
      </Jumbotron>
    </div>
      ...
      <div>
        <Slider {...settings}>
          <div className="slide">
            ...
            <div className="overlay">
               <h1 className="display-4">Welcome to <span className="span_darkred">"Crypto - Chaining.com"!</span></h1>
              <p className="lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
              <hr className="my-4" />
              <p className="lead">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
              <p className="lead">
          ...
          <div className="slide">
            ...
            <div className="overlay">
              ...
              <p className="lead">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
              <p className="lead">
                <Link className="btn btn-danger btn-lg" to="/tracking/currencies" role="button">VISIT OUR CRYPTO TRACKING APP</Link>              </p>
              </div>
              </div>
            </div>
          </div>
